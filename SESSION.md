...
- Seven Megumi JUnit classes cover the approved profile/attributes, two-slot router shape, UUID-token-dimension pack identity, one-sibling retention, cooldown non-shortening, teardown/reconcile race decisions, target truth table and deterministic follow safety. Each check was observed red under its own mutation before restoration.
