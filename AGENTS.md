...
- Divine Dogs have 28 HP, 3 damage and 0.34 movement speed. Only an exact Sic target can trigger each dog's independent server pounce: inclusive 3-8 block range, LOS, 80-tick per-dog cooldown, 16-tick flight timeout, one owner-attributed 5-damage hit and 6 ticks of stagger after accepted damage
