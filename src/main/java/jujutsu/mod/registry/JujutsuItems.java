...
public final class JujutsuItems {
	public static final Item HAIRPIN_NAIL = create("hairpin_nail", new Item.Properties().stacksTo(64));
	public static final Item STRAW_DOLL_HAMMER = create("straw_doll_hammer", new Item.Properties().stacksTo(1).durability(256));
	...
	private static Item create(String path, Item.Properties properties) {
