...
public final class CursedIncidentVfxIds {
	...
	public static final Set<ResourceLocation> LIVE = Set.of(
			ZONE_AMBIENT, STAGE_PULSE, SEAL_DEGRADE, SEAL_BREAK, SECONDARY_BIRTH);
	...
	public static final Set<ResourceLocation> PHYSICAL = Set.of(STAGE_PULSE, SEAL_BREAK, SECONDARY_BIRTH);
