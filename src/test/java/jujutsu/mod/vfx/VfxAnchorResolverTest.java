...
public final class VfxAnchorResolverTest {
	...
	private static void assertStaticCueUsesOrigin() {
		VfxCue cue = new VfxCue(NobaraVfxIds.HAMMER, new Vec3(1.0, 2.0, 3.0), VfxCue.NO_ANCHOR, Vec3.ZERO, 1, 0L, 1L);
	...
	private static void assertZeroOffsetUsesLiveAnchor() {
		VfxCue cue = new VfxCue(NobaraVfxIds.HAMMER, Vec3.ZERO, 17, Vec3.ZERO, 1, 0L, 2L);
	...
	private static void assertLiveAnchorAppliesOffset() {
		...
		VfxCue cue = new VfxCue(NobaraVfxIds.DETONATE, eyeOffset, 17, eyeOffset, 1, 0L, 3L);
	...
	private static void assertMissingAnchorFallsBackToOrigin() {
		...
		VfxCue cue = new VfxCue(NobaraVfxIds.EXPLOSION, origin, 23, new Vec3(0.0, 1.2, 0.0), 1, 0L, 4L);
