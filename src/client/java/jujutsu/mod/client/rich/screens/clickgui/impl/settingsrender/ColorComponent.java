package jujutsu.mod.client.rich.screens.clickgui.impl.settingsrender;

import net.minecraft.client.gui.GuiGraphics;
import org.lwjgl.glfw.GLFW;
import jujutsu.mod.client.rich.modules.module.setting.implement.ColorSetting;
...
public class ColorComponent extends AbstractSettingComponent {
    ...
    private void copyHexToClipboard() {
        if (hasHexSelection()) {
            GLFW.glfwSetClipboardString(mc.getWindow().getWindow(), "#" + getHexSelectedText());
        } else if (!hexInputText.isEmpty()) {
            GLFW.glfwSetClipboardString(mc.getWindow().getWindow(), "#" + hexInputText);
        }
    }
