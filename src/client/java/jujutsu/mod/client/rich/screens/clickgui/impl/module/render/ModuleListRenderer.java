package jujutsu.mod.client.rich.screens.clickgui.impl.module.render;
...
public class ModuleListRenderer {
    ...
    public void render(GuiGraphics context, List<ModuleStructure> displayModules, ModuleStructure selectedModule,
    ...
    private void renderModuleItems(GuiGraphics context, List<ModuleStructure> moduleList, Map<ModuleStructure, Float> animations,
