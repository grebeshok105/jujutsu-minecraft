package jujutsu.mod.client.rich.screens.clickgui.impl.background.search;
...
public class SearchRenderer {
    ...
    public void render(GuiGraphics context, float bgX, float bgY, float bgWidth, float bgHeight,
