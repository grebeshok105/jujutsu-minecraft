package jujutsu.mod.client.rich.screens.clickgui.impl.module;
...
import jujutsu.mod.client.rich.modules.module.setting.SettingComponentAdder;
import jujutsu.mod.client.rich.screens.clickgui.impl.module.handler.ModuleAnimationHandler;
import jujutsu.mod.client.rich.screens.clickgui.impl.module.handler.ModuleBindHandler;
import jujutsu.mod.client.rich.screens.clickgui.impl.module.handler.ModuleFavoriteHandler;
import jujutsu.mod.client.rich.screens.clickgui.impl.module.handler.ModuleScrollHandler;
import jujutsu.mod.client.rich.screens.clickgui.impl.module.render.ModuleListRenderer;
import jujutsu.mod.client.rich.screens.clickgui.impl.module.render.SettingsPanelRenderer;
import jujutsu.mod.client.rich.screens.clickgui.impl.module.util.ModuleDisplayHelper;
import jujutsu.mod.client.rich.screens.clickgui.impl.settingsrender.*;
...
public class ModuleComponent implements IMinecraft {
    ...
    public void renderModuleList(GuiGraphics context, float x, float y, float width, float height,
    ...
    public void renderSettingsPanel(GuiGraphics context, float x, float y, float width, float height,
