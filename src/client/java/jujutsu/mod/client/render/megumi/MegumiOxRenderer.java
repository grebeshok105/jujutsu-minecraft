...
public final class MegumiOxRenderer extends
	...
	public void extractRenderState(MegumiOxEntity entity, MegumiShikigamiRenderState state, float partialTick) {
		...
		// This shikigami has no melee swing; reuse the shared numeric slot to transport its synced
		// action timer to the client clip selector without adding another render-state field.
		state.attackAnim = entity.actionTicks();
	}
