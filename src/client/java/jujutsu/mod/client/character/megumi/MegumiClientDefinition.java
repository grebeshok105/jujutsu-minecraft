...
import jujutsu.mod.client.render.megumi.MegumiElephantRenderer;
import jujutsu.mod.client.render.megumi.MegumiNueRenderer;
import jujutsu.mod.client.render.megumi.MegumiRabbitRenderer;
import jujutsu.mod.client.render.megumi.MegumiDeerRenderer;
import jujutsu.mod.client.render.megumi.MegumiOxRenderer;
import jujutsu.mod.client.render.megumi.MegumiSerpentRenderer;
import jujutsu.mod.client.render.megumi.MegumiTigerRenderer;
...
public final class MegumiClientDefinition implements CharacterClientDefinition {
	...
	public void registerClientHooks() {
		...
		EntityRendererRegistry.register(JujutsuEntities.MEGUMI_TOAD, MegumiToadRenderer::new);
		...
		EntityRendererRegistry.register(JujutsuEntities.MEGUMI_SERPENT, MegumiSerpentRenderer::new);
		EntityRendererRegistry.register(JujutsuEntities.MEGUMI_DEER, MegumiDeerRenderer::new);
		EntityRendererRegistry.register(JujutsuEntities.MEGUMI_OX, MegumiOxRenderer::new);
		EntityRendererRegistry.register(JujutsuEntities.MEGUMI_TIGER, MegumiTigerRenderer::new);
