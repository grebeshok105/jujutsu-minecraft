...
- **Фиксы по фидбеку пользователя** (2bb3d6e): fade-рассинхрон (shockwave не умножался на fade → кольцо догорало отдельно) → shockwave×fade + радиус схлопывается в 0; интерьер cyan-залив (ring до ~100 + 10/dist²) → ring≤2.0, total≤1.5.
