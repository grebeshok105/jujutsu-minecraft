...
- Every current Nobara HUD/camera/first-person/post-process/time recipe call must preserve `initialAgeTicks`; the exact 35-call guard intentionally fails when one silently falls back to a fresh overload.
