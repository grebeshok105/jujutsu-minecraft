...
| Field | Value | Source |
|---|---|---|
| mod id | jujutsumod | JujutsuMod.MOD_ID, fabric.mod.json |
| name | Jujutsu Minecraft | fabric.mod.json |
| Minecraft | 1.21.8 | gradle.properties, fabric.mod.json |
| Java | 21 | build.gradle, fabric.mod.json |
| Fabric Loader | >=0.19.3 | fabric.mod.json |
