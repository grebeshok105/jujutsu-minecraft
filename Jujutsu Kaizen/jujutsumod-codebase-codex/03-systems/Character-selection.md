...
3. The departing vessel's `onDeselected` hook runs before the new selection is stored, so it still sees itself selected — Todo's pair-selection, stone, and momentum cleanup lives there, as does Megumi's pack/shadow teardown.
