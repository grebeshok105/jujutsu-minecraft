...
Accepted ordinary nail hits open embed windows, create concrete embedded nail anchors, apply/refresh target marks, and record anchor depth/origin/targetId metadata. Remnant extraction is separate: the overhead hammer can mint a bound remnant only from a deeply anchored target.
